      ...
      <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 sm:py-24">
        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed text-paper-muted">
          <section>
            ...
            <p className="mt-3">
              Every KamiraFit garment is carefully quality-checked and prepared in our fulfillment center. Orders are typically processed and handed over to our courier partners within <strong className="text-paper">24 to 48 hours</strong> (excluding Saturdays, Sundays and national holidays).
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-line bg-ink-2/40 p-5">
                <h3 className="font-medium text-paper">Worldwide</h3>
                <p className="mt-2 text-2xl font-semibold text-gold">7 – 14 Days</p>
                <p className="mt-1 text-xs text-paper-muted">Cities, and regional destinations with direct pin-code connectivity.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5">
              <li><strong className="text-paper">Orders above ₹999:</strong> Free Standard Shipping across India.</li>
              <li><strong className="text-paper">Orders below ₹999:</strong> A delivery fee depending on your location will be applicable at checkout.</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-lg font-medium text-paper">4. Packaging Integrity</h2>
            <p className="mt-3">
