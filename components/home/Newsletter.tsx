      ...
      <Container>
        <div className="rounded-3xl bg-neutral-900 px-6 py-14 text-center text-white sm:px-12 sm:py-20">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-neutral-300 sm:text-base">
            Early access to new drops, private sales, and the occasional
            styling note. No spam, ever.
          </p>
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-medium text-neutral-900 transition-colors hover:bg-neutral-200"
            >
              Subscribe
            </button>
          </form>
